...
Schema::create('product_sku_attribute', function($table) {
 $table->increments('sku_id')->unsigned();
 $table->increments('attribute_id')->unsigned();
 });
...
Schema::create('product_variation', function($table) {
 $table->increments('product_id')->unsigned();
 $table->increments('variation_id')->unsigned();
 });
...
Schema::create('variation_attribute', function($table) {
 $table->increments('id')->unsigned();
 $table->unsignedInteger('variation_id')->nullable()->unsigned();
