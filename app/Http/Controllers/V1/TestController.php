...
class Create" . str_replace('_', '', self::$database) . "Database {
//
...
" . self::$down . "
    ...
    public function write()
    {
        ...
        $path = '/var/www/projects/ecommerce/api-gateway';
        file_put_contents("{$path}/database/migrations/{$filename}", $schema);
    }
